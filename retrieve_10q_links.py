...
# Read the NCT csv
NCTdf = pd.read_csv('C:/Users/jsbae/financialsummary/TechStocks_NameCIKTicker.csv')
...
prev_links = open('C:/Users/jsbae/financialsummary/links.txt').read().splitlines()
...
for stock_idx in range(tot_stocks):
    ...
    if NCTdf['Queried'][stock_idx] == 0:
        ...
        try:  # just in case the api runs out of calls (didnt happen tho)
            ...
            NCTdf.to_csv('C:/Users/jsbae/financialsummary/TechStocks_NameCIKTicker.csv')
